...
namespace MessageSender
{
    ...
    internal sealed class SocketClient : IDisposable
    {
        ...
        /// <summary>
        /// MemoryStream to store incoming data
        /// </summary>
        ...
        private void OnReceive(object sender, SocketAsyncEventArgs e)
        {
            ...
            memStream.Write(e.Buffer, 0, e.Buffer.Length);
        ...
        internal byte[] SendReceive(byte[] sendBuffer, int timeout)
        {
            if (this.connected)
            {
                ...
                foreach (var e in autoSendReceiveEvents)
                {
                    e.WaitOne();
                }

                // Return data from SocketAsyncEventArgs buffer.
                byte[] ret = memStream.ToArray();
                return ret;
            }
            else
            {
