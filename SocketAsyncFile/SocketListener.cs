...
namespace SocketAsyncFile
{
    ...
    internal sealed class SocketListener
    {
        ...
        private void CloseClientSocket(Token token, SocketAsyncEventArgs e)
        {
            ...
            Console.WriteLine("Client disconnected from the server. There are {0} clients connected to the server", this.numConnectedSockets);
        ...
        internal string Start(Int32 port)
        {
            ...
            if (localEndPoint.AddressFamily == AddressFamily.InterNetworkV6)
            {
                ...
                this.listenSocket.Bind(new IPEndPoint(addressList[0], localEndPoint.Port)); // (IPAddress.IPv6Any,
            }
            else
            {
